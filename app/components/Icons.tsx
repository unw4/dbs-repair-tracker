...
/** ⏳ Kum saati — Parça Bekleniyor */
export function IconHourglass({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
